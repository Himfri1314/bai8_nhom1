<html lang="vi">
  ...
  <body>
     <!-- Banner -->
    <div class="banner">
        <h1 style="text-align:center;text-decorating: none; color: white; padding: 0 30px;">Bài 8: ĐỊNH DẠNG VĂN BẢN</h1>
    </div>
  </body>
    <style>
      body {
...
.banner h1 {
  ...
  <div style="background-color: #FFFFFF; padding: 10px;">
  		<h2>Luyện tập 1: Hãy sửa lại phần tử sau để làm nổi bật ý chính của câu: < p> thẻ strong vào thẻ em được sử dụng để nhấn mạnh vào nội dung trong phần tử. Thẻ B chỉ có tác dụng in đậm văn bản < p></h2> 
  </div>
   ...
   <div style="background-color: #FFFFFF; padding: 10px;">
        <h2>Luyện tập 2: Luyện tập 2: Trình bày đoạn văn bản sau bằng mã HTML:</h2>
   </div>
    ...
    <h1 style="text-align:center;text-decorating: none; color: #243b9a; padding: 0 30px;">VẬN DỤNG</h1>
          ...
          <div style="background-color: #FFFFFF; padding: 10px;">
        <h2>Vận dụng 1: Vận dụng 1: Hãy chỉ ra các bước cần thực hiện để sử dụng một màu cụ thể trong bức ảnh làm màu cho tiêu đề một bài thơ.</h2>
          </div>
        <p>Các bước cần thực hiện:</p>
      <p>• Bước 1. Mở ảnh bằng phần mềm có chức năng chỉnh sửa (GIMP,Paint, ...)</p>
      ...
      <p>• Bước 4. Sử dụng giá trị RGB của màu đã chọn để thiết lập màu cho tiêu đề bài thơ bằng đặc tính color trong thuộc tính style</p>
          <div style="background-color: #FFFFFF; padding: 10px;">
        <h2>Vận dụng 2: Hãy đưa ra các định dạng một đoạn văn bản để được kết quả như sau:</h2>
          </div>
        <img src="vandung2.png">
